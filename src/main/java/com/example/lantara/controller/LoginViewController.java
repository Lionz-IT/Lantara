...
import javafx.application.Platform; // <-- Import ini ditambahkan
...
public class LoginViewController {
    ...
    @FXML private Label titleLabel; // Sesuaikan jika ada

    private String selectedRole;

    @FXML
    public void initialize() {
        // --- PERBAIKAN FOKUS OTOMATIS ---
    ...
    private void handleBackButton() {
        try {
            ...
            MainApp.setStageIcon(roleStage); // Set ikon
    ...
    private void openMainWindow(User user) {
        try {
            ...
            MainApp.setStageIcon(mainStage); // Set ikon
